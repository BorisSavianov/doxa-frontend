...
const Profile = () => {
  ...
  const tabs = [
    ...
    { id: 'skills', label: t('Умения', 'Skills') }
  ]
            ...
            <div className="profile-main-info">
              <div className="name-section">
                <img 
                  ...
                  onError={(e) => {
                    e.target.src = 'data:image/svg+xml;base64,'
                  }}
                />
                <div>
